...
function sumArray(array) {
    ...
    return sumArray(array.slice(0, -1)) + sumArray(array.slice(-1))
}
...
function flatten(data) {
    ...
    if ( data.length != 0) {
        let arr = flatten(data[0]).concat(flatten(data.slice(1)))
        let len = flatten(data[0]).concat(flatten(data.slice(1))).length
...
// console.log(fileFinder(desktop, 'everlong.flac'));
// console.log(fileFinder(desktop, 'express_yourself.wav'));
// console.log(fileFinder(desktop, 'hamilton.jpeg'));
...
// console.log(pathFinder(desktop, 'express_yourself.wav'));
// console.log(pathFinder(desktop, 'hamilton.jpeg'));
